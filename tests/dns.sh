...
systemd-run --service-type=notify --same-dir --unit=gatekeeper-dns --setenv=LAN=$DEV_A --setenv=LOG_TO_FILE=$LOG_TO_FILE --quiet build/debug_gatekeeper
